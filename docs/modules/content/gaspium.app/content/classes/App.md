...
**Signature:** (self, title='Application', geometry='800x500', theme=<tkstyle.Theme object at 0x7ff48ee62fa0>, caching=False, resizable=(True, True), on\_stop=None, on\_exit=None, crash\_resistant=True, navbar=<class 'gaspium.misc.Navbar'>)
