...
**Signature:** (self, parent=None, title=None, text=None, readonly=False, width=45, height=10, side='left', anchor='nw', padx=5, pady=5, expand=False, fill=None)
...
**Signature:** (self, title=None, text=None, readonly=None)
