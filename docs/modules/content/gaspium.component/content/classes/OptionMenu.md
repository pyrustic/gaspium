...
**Signature:** (self, parent=None, title=None, items=None, prompt='- Select -', selection=None, on\_select=None, side='left', anchor='nw', padx=5, pady=5, expand=False, fill=None)
